  ...
  return (
    <div className="space-y-6 mt-8">
      <Card className="bg-slate-900 border-slate-800">
        <CardHeader className="border-b border-slate-800 bg-slate-950/30 pb-4">
          <CardTitle className="text-lg">Executive Summary</CardTitle>
        </CardHeader>
        <CardContent className="pt-4">
          <p className="text-slate-300">{brief.content.summary}</p>
        </CardContent>
      </Card>
      ...
      <Card className="bg-sky-950/20 border-sky-900/50">
        <CardHeader className="border-b border-sky-900/30 bg-sky-950/40 pb-4">
          <CardTitle className="text-lg text-sky-400">What to Say</CardTitle>
        </CardHeader>
        <CardContent className="pt-6">
          <blockquote className="border-l-4 border-sky-500 pl-4 italic text-slate-300 text-lg">
