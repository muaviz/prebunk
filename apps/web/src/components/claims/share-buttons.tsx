  ...
  return (
    <div className="flex flex-col gap-2.5 mt-4">
      ...
      <a 
        ...
        className="flex items-center justify-center gap-2 h-11 w-full rounded-md text-sm font-medium transition-colors text-white bg-[#128C7E] hover:bg-[#075E54]"
      >
      ...
      <a 
        ...
        className="flex items-center justify-center gap-2 h-11 w-full rounded-md text-sm font-medium transition-colors text-white bg-[#006699] hover:bg-[#005580]"
      >
      ...
      <a 
        ...
        className="flex items-center justify-center gap-2 h-11 w-full rounded-md text-sm font-medium transition-colors text-white bg-[#D93A00] hover:bg-[#B33000]"
      >
